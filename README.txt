...
# CREATE
Using the Create Command you will be able to insert a new document into the DB.
...
# READ
Calling the testRead method will find and print out the requested document. And Error message will appear if the document can not be located.
